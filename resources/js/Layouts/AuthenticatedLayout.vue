                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('welcome')"
                                    class="flex flex-row items-center gap-[12px] text-[18px]">
                        ...
                        <div class=" flex ">
                            <div class="relative inline-flex items-center">
                                <CartButton method="GET" :href="route('cart.show')" />
                                <span v-if="cartCount >= 1" class="absolute -top-[-5px] -right-2 bg-red-600 text-white text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center shadow-lg" >
                                    {{ cartCount }}
                                </span>
                            </div>
                                ...
                                <div class="relative ms-3">
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            ...
                                            <DropdownLink v-if="$page.props.auth.user?.is_admin === true"
                                                :href="route('admin.adminpanel')">
                                                Админ-панель
                                            </DropdownLink>
